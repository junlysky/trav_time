...
c     write(0,*)'Input number_of_layers layer_src_at_botom rcv_layer'
	 ...
	 rcv_lay = i
      ...
      IF (num_lay .GT. max_num_lay) THEN
         ...
         CALL EXIT(1)
      ENDIF
c     write(0,*)'Input thickness of each layer and velocity'
      do i=1,num_lay
        read(*,*) thk(i),vps(1,i)
...
c      write(0,*)'Input the number of distance ranges'
      read(*,*) nx
c      write(0,*)'Input distance range (in km)'
      do i=1,nx
        read(*,*) x
c direct arrival
	topp = rcv_lay + 1
